...
<head>
  ...
  <!-- Google Font -->
  <link rel="stylesheet"
        href="<?php echo base_url('assets/admin/') ?>https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
</head>
<!--
BODY TAG OPTIONS:
=================
...
?>
<form role="form" action="<?php echo base_url(); ?>index.php/admin/saveplane" method="POST">
  <input type="hidden" name="op" value="<?php echo $op; ?>" class="form-control">
  <input type="hidden" class="form-control" name="id" value="<?php echo $id; ?>">
  <div class="form-group">
    <label for="inputName3" class="col-sm-2 control-label">Code</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="code" value="<?php echo $code; ?>" placeholder="Code">
    </div>
  </div>
  <div class="form-group">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputName3" class="col-sm-2 control-label">Seat Quantity</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="seat_qty" value="<?php echo $seat_qty; ?>" placeholder="Seat Quantity">
    </div>
  </div>
  <div class="form-group">
